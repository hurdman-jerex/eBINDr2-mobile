...
this.timer=this.hide.delay(this.options.hideDelay,this,b);this.fireForParent(c,b);},fireForParent:function(c,b){if(!b){return;}if(b.getParent == 'function'){parentNode=b.getParent();}else{return;}
