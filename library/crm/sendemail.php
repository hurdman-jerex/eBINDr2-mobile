<div style="float: left; width: 30%;">
    ...
    <h5 style="margin-top: 25px; padding-top: 5px;">Personal Message</h5>
    <textarea id="mail_body" name="body" rows="7" style="width: 100%;" placeholder="Enter your message here, then click on the preview to view it there"></textarea>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#mail_code').change( function() {
            ...
            $("#sales_container").height(iframedoc.body.scrollHeight);
        });
